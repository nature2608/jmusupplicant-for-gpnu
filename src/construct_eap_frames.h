...
const static unsigned int EAPOL_START_SECONDRY_MAC_ADDR=0x6c;
...
const static unsigned int EAP_IDENTITY_PADDING_LENGTH = 24;
const static unsigned int EAP_IDENTITY_TRAILER_LENGTH = 482;
const static unsigned int EAP_IDENTITY_RESPONSE_SERVICE_NAME_ADDR = 0x175;
const static unsigned int EAP_IDENTITY_RESPONSE_IP_ADDR = 0x29;
const static unsigned int EAP_IDENTITY_RESPONSE_NETMASK_ADDR = 0X2e;
const static unsigned int EAP_IDENTITY_RESPONSE_GATEWAY_ADDR = 0X32;
const static unsigned int EAP_IDENTITY_RESPONSE_SECONDRY_MAC_ADDR = 0X7e;//新加mac填充位置
...
const static unsigned int EAP_MD5_CHALLENGE_PADDING_LENGTH = 7;
const static unsigned int EAP_MD5_CHALLENGE_TRAILER_LENGTH = 515;
const static unsigned int SERVICE_NAME_LENGTH = 32;

const static unsigned int EAP_MD5_RESPONSE_IP_ADDR = 0X3a;
const static unsigned int EAP_MD5_RESPONSE_NETMASK_ADDR = 0X3e;
const static unsigned int EAP_MD5_RESPONSE_GATEWAY_ADDR = 0X42;
const static unsigned int EAP_MD5_RESPONSE_COMPUTE_PASSWORD_ADDR = 0X9d;
const static unsigned int EAP_MD5_RESPONSE_COMPUTE_V4_ADDR = 0X10e;
const static unsigned int EAP_MD5_RESPONSE_SERVICE_NAME_ADDR = 0X196;
const static unsigned int EAP_MD5_RESPONSE_SECONDRY_MAC_ADDR = 0X8f;//新加mac填充位置
